...
# ========== HTML страница с кнопками управления звуком ==========
    ...
    <script>
        ...
        async function startCall() {
            ...
            try {
                ...
                // Сохраняем аудио треки для управления
        ...
        function adjustVolume(value) {
            ...
            // Меняем цвет ползунка в зависимости от уровня громкости
        ...
        function resetCallState() {
            ...
            // Скрываем панель управления звуком
        ...
        window.onload = () => {
            ...
            // Инициализируем ползунок громкости
            adjustVolume(80);
...
async def main():
    """Запускаем сервер"""
    print("=" * 60)
    print("🎧 ГОЛОСОВОЙ ЧАТ С CLOUDPUB И УПРАВЛЕНИЕМ ЗВУКОМ")
    print("=" * 60)
    ...
    print("=" * 60)
    print("🎛️  Доступные функции управления звуком:")
    print("   • 🎤 Вкл/Выкл микрофона")
    print("   • 🔈 Вкл/Выкл динамиков")
    print("   • 🔊 Регулировка громкости (0-100%)")
    print("=" * 60)
